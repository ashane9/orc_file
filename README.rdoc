=ORCFILE
Ruby Gem for writing Apaache Optimized Row Columnar (ORC) files.
This gem can also be paired using the dif_fileio plugin for sequel and/or factory_girl gem.
